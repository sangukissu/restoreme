...
import { signUp, signInWithMagicLink, signInWithGoogle } from "@/lib/actions"
  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-semibold tracking-tight text-black">Create an account</h1>
        <p className="text-lg text-gray-600">Get started with Restore.me</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm">
        ...
        <div className="mt-6 space-y-4">
          ...
          >
            {showMagicLink ? "Back to password signup" : "Use magic link instead"}
          </Button>
        </div>
